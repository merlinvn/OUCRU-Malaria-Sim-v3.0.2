...
std::map<std::string, GuiReporter::CommandEnum >GuiReporter::CommandsMap = std::map<std::string, GuiReporter::CommandEnum >();
...
void GuiReporter::CreateWindowsTab(const std::string& command, const std::string& tabType, const std::string& tabName, const std::string& tabTitle) {
...
void GuiReporter::CreateWindowsTableTab(const std::string& command, const std::string& tabType, const std::string& tabName, const std::string& tabTitle, const std::string& switchRowWithColumn) {
    std::cout << command << SEPARATOR <<
            tabType << SEPARATOR <<
            tabName << SEPARATOR <<
            tabTitle << SEPARATOR <<
...
void GuiReporter::SendLineChartData(const std::string& chartName, const std::string& legend, const std::string& xValue, const std::string& yValue, const std::string& yAxis) {
...
void GuiReporter::SendBarChartData(const std::string& chartName, const std::string& category, const std::string& legend, const std::string& xValue, const std::string& yValue, const std::string& yAxis) {
    std::cout << "ChartData" << SEPARATOR <<
            chartName << SEPARATOR <<
            category << SEPARATOR <<
            legend << SEPARATOR <<
...
void GuiReporter::SendTabData(const std::string& tabName, const std::string& group, const std::string& category, const std::string& time, const std::string& data, const std::string& format) {
...
void GuiReporter::send_prevalence_chart_data_for_location(const int& location) {
    ...
    SendLineChartData(chart_name, "Blood Slide", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<double>(Model::DATA_COLLECTOR->blood_slide_prevalence_by_location()[location]), "0");
    SendLineChartData(chart_name, "Clinical", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<double>(Model::DATA_COLLECTOR->fraction_of_positive_that_are_clinical_by_location()[location]), "0");
    SendLineChartData(chart_name, "Immune Level", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<double>(Model::DATA_COLLECTOR->total_immune_by_location()[location] / Model::DATA_COLLECTOR->popsize_by_location()[location]), "1");
}
...
void GuiReporter::send_multiple_infection_chart_data(const int& location) {
    ...
    SendBarChartData(chart_name, "1", "Number of Infection", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<int>(Model::DATA_COLLECTOR->multiple_of_infection_by_location()[location][0]), "0");
    SendBarChartData(chart_name, "2", "Number of Infection", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<int>(Model::DATA_COLLECTOR->multiple_of_infection_by_location()[location][1]), "0");
    SendBarChartData(chart_name, "3", "Number of Infection", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<int>(Model::DATA_COLLECTOR->multiple_of_infection_by_location()[location][2]), "0");
    SendBarChartData(chart_name, ">3", "Number of Infection", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<int>(Model::DATA_COLLECTOR->multiple_of_infection_by_location()[location][3]), "0");
}
...
void GuiReporter::send_mono_resistance_chart_data(const int& location) {
    ...
    SendLineChartData(mono_chart_name, "Non Resistance", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<double>(Model::POPULATION->current_force_of_infection_by_location_parasite_type()[location][0]), "0");
...
void GuiReporter::send_double_resistance_chart_data(const int& location) {
    ...
    for (it = Model::CONFIG->genotype_db()->db().begin(); it != Model::CONFIG->genotype_db()->db().end(); it++) {
        if (it->second->number_of_resistance_position() == 2) {
            ...
            SendLineChartData(double_chart_name, NumberToString<int>(d_id), NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<double>(num), "0");
        }
...
void GuiReporter::send_mean_MOI_chart_data(const int& location) {
    ...
    SendLineChartData(double_chart_name, "Mean MOI", NumberToString<int>(Model::SCHEDULER->current_time()), NumberToString<double>(boost::accumulators::mean(Model::DATA_COLLECTOR->acc)), "0");
