...
double ImmuneSystem::get_parasite_size_after_t_days(const int &duration, const double &originalSize,
    ...
    double temp = Model::CONFIG->immune_system_information().c_max * (1 - lastImmuneLevel) +
                  Model::CONFIG->immune_system_information().c_min * lastImmuneLevel;
...
double ImmuneSystem::get_clinical_progression_probability() const {
    ...
    double PClinical = isf.max_clinical_probability /
