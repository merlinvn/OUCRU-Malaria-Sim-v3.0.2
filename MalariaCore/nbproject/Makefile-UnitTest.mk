...
${OBJECTDIR}/IStrategy.o: IStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DUNITTEST=\"True\" -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IStrategy.o IStrategy.cpp
...
${OBJECTDIR}/MFTRebalancingStrategy.o: MFTRebalancingStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DUNITTEST=\"True\" -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MFTRebalancingStrategy.o MFTRebalancingStrategy.cpp
...
${OBJECTDIR}/StrategyBuilder.o: StrategyBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DUNITTEST=\"True\" -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StrategyBuilder.o StrategyBuilder.cpp
...
${OBJECTDIR}/TherapyBuilder.o: TherapyBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DUNITTEST=\"True\" -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TherapyBuilder.o TherapyBuilder.cpp
