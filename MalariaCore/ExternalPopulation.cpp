...
double ExternalPopulation::get_current_daily_EIR_by_location(const int& current_time, const int& location, const int& parasite_type_id) {
    ...
    double seasonality = Model::CONFIG->seasonality(current_time, Model::CONFIG->spatial_external_population_information().seasonal_EIR.a[location], Model::CONFIG->spatial_external_population_information().seasonal_EIR.phi_upper[location], Model::CONFIG->spatial_external_population_information().seasonal_EIR.phi_lower[location]);
