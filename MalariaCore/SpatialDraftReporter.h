/* 
 * File:   SpatialDraftReporter.h
 * Author: jan
 *
 * Created on August 19, 2016, 10:48 AM
 */

#ifndef SPATIALDRAFTREPORTER_H
#define	SPATIALDRAFTREPORTER_H

#include "Reporter.h"

class SpatialDraftReporter : public Reporter {
    DISALLOW_COPY_AND_ASSIGN_(SpatialDraftReporter)
...
public:
    ...
    void print_resistance_tracker_by_location();
    ...
    // Giang's addition
    void print_pop_size_by_location();
    void print_total_parasite_population_count();
    
    void print_NTF_in_60_days_window();
    void print_blood_slide_prevalence_all_locations();
    void print_blood_slide_prevalence_by_location();

private:

};

#endif	/* SPATIALDRAFTREPORTER_H */
