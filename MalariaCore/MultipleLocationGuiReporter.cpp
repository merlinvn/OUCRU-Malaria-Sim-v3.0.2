...
void MultipleLocationGuiReporter::send_tme_chart_data(const int& location) {
    ...
    double qPCR = (Model::DATA_COLLECTOR->popsize_by_location_hoststate()[location][Person::ASYMPTOMATIC] + Model::DATA_COLLECTOR->popsize_by_location_hoststate()[location][Person::CLINICAL]) / (double) Model::DATA_COLLECTOR->popsize_by_location()[location];
    double RDT = 0.1 * qPCR;
