...
${OBJECTDIR}/Genotype.o: Genotype.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DUNITTEST=\"True\" -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Genotype.o Genotype.cpp
...
${OBJECTDIR}/ParasiteDatabase.o: ParasiteDatabase.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DUNITTEST=\"True\" -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParasiteDatabase.o ParasiteDatabase.cpp
