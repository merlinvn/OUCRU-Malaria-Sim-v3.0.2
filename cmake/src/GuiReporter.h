...
public:
    ...
    void CreateWindowsTableTab(const std::string &command, const std::string &tabType, const std::string &tabName, const std::string &tabTitle, const std::string &switchRowWithColumn);

    void SendLineChartData(const std::string &chartName, const std::string &legend, const std::string &xValue, const std::string &yValue, const std::string &yAxis);
    void SendBarChartData(const std::string &chartName, const std::string &category, const std::string &legend, const std::string &xValue, const std::string &yValue, const std::string &yAxis);
    void SendTabData(const std::string &tabName, const std::string &group, const std::string &category, const std::string &time, const std::string &data, const std::string &format);
