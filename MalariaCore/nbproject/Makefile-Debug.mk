...
${OBJECTDIR}/ACTIncreaseStrategy.o: ACTIncreaseStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ACTIncreaseStrategy.o ACTIncreaseStrategy.cpp

${OBJECTDIR}/AMUReporter.o: AMUReporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AMUReporter.o AMUReporter.cpp
...
${OBJECTDIR}/BirthdayEvent.o: BirthdayEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BirthdayEvent.o BirthdayEvent.cpp
...
${OBJECTDIR}/CSVRow.o: CSVRow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSVRow.o CSVRow.cpp

${OBJECTDIR}/CirculateToTargetLocationNextDayEvent.o: CirculateToTargetLocationNextDayEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CirculateToTargetLocationNextDayEvent.o CirculateToTargetLocationNextDayEvent.cpp

${OBJECTDIR}/ClinicalUpdateFunction.o: ClinicalUpdateFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClinicalUpdateFunction.o ClinicalUpdateFunction.cpp

${OBJECTDIR}/ClonalParasitePopulation.o: ClonalParasitePopulation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClonalParasitePopulation.o ClonalParasitePopulation.cpp
...
${OBJECTDIR}/CyclingStrategy.o: CyclingStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CyclingStrategy.o CyclingStrategy.cpp
...
${OBJECTDIR}/Drug.o: Drug.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Drug.o Drug.cpp

${OBJECTDIR}/DrugDatabase.o: DrugDatabase.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DrugDatabase.o DrugDatabase.cpp

${OBJECTDIR}/DrugType.o: DrugType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DrugType.o DrugType.cpp

${OBJECTDIR}/DrugsInBlood.o: DrugsInBlood.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DrugsInBlood.o DrugsInBlood.cpp

${OBJECTDIR}/EndClinicalByNoTreatmentEvent.o: EndClinicalByNoTreatmentEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EndClinicalByNoTreatmentEvent.o EndClinicalByNoTreatmentEvent.cpp

${OBJECTDIR}/EndClinicalDueToDrugResistanceEvent.o: EndClinicalDueToDrugResistanceEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EndClinicalDueToDrugResistanceEvent.o EndClinicalDueToDrugResistanceEvent.cpp

${OBJECTDIR}/EndClinicalEvent.o: EndClinicalEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EndClinicalEvent.o EndClinicalEvent.cpp
...
${OBJECTDIR}/ExternalPopulation.o: ExternalPopulation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExternalPopulation.o ExternalPopulation.cpp
...
${OBJECTDIR}/ImmuneComponent.o: ImmuneComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImmuneComponent.o ImmuneComponent.cpp

${OBJECTDIR}/ImmuneSystem.o: ImmuneSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImmuneSystem.o ImmuneSystem.cpp

${OBJECTDIR}/ImmunityClearanceUpdateFunction.o: ImmunityClearanceUpdateFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImmunityClearanceUpdateFunction.o ImmunityClearanceUpdateFunction.cpp

${OBJECTDIR}/ImportationEvent.o: ImportationEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImportationEvent.o ImportationEvent.cpp

${OBJECTDIR}/ImportationPeriodicallyEvent.o: ImportationPeriodicallyEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImportationPeriodicallyEvent.o ImportationPeriodicallyEvent.cpp

${OBJECTDIR}/IndexHandler.o: IndexHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndexHandler.o IndexHandler.cpp

${OBJECTDIR}/InfantImmuneComponent.o: InfantImmuneComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InfantImmuneComponent.o InfantImmuneComponent.cpp

${OBJECTDIR}/IntGenotype.o: IntGenotype.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IntGenotype.o IntGenotype.cpp
...
${OBJECTDIR}/MACTherapy.o: MACTherapy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MACTherapy.o MACTherapy.cpp

${OBJECTDIR}/MDAAction.o: MDAAction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MDAAction.o MDAAction.cpp

${OBJECTDIR}/MFTRebalancingStrategy.o: MFTRebalancingStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MFTRebalancingStrategy.o MFTRebalancingStrategy.cpp
...
${OBJECTDIR}/MatureGametocyteEvent.o: MatureGametocyteEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatureGametocyteEvent.o MatureGametocyteEvent.cpp
...
${OBJECTDIR}/MonthlyReporterConsole.o: MonthlyReporterConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonthlyReporterConsole.o MonthlyReporterConsole.cpp

${OBJECTDIR}/MoveParasiteToBloodEvent.o: MoveParasiteToBloodEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MoveParasiteToBloodEvent.o MoveParasiteToBloodEvent.cpp

${OBJECTDIR}/MoveToExternalPopulationEvent.o: MoveToExternalPopulationEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MoveToExternalPopulationEvent.o MoveToExternalPopulationEvent.cpp

${OBJECTDIR}/MultipleLocationGuiReporter.o: MultipleLocationGuiReporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultipleLocationGuiReporter.o MultipleLocationGuiReporter.cpp

${OBJECTDIR}/NestedSwitchingStrategy.o: NestedSwitchingStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NestedSwitchingStrategy.o NestedSwitchingStrategy.cpp

${OBJECTDIR}/NonInfantImmuneComponent.o: NonInfantImmuneComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NonInfantImmuneComponent.o NonInfantImmuneComponent.cpp

${OBJECTDIR}/NovelNonACTSwitchingStrategy.o: NovelNonACTSwitchingStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NovelNonACTSwitchingStrategy.o NovelNonACTSwitchingStrategy.cpp

${OBJECTDIR}/ParasiteDensityUpdateFunction.o: ParasiteDensityUpdateFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParasiteDensityUpdateFunction.o ParasiteDensityUpdateFunction.cpp
...
${OBJECTDIR}/PersonIndex.o: PersonIndex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndex.o PersonIndex.cpp

${OBJECTDIR}/PersonIndexAll.o: PersonIndexAll.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexAll.o PersonIndexAll.cpp

${OBJECTDIR}/PersonIndexAllHandler.o: PersonIndexAllHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexAllHandler.o PersonIndexAllHandler.cpp

${OBJECTDIR}/PersonIndexByLocationBittingLevel.o: PersonIndexByLocationBittingLevel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationBittingLevel.o PersonIndexByLocationBittingLevel.cpp

${OBJECTDIR}/PersonIndexByLocationBittingLevelHandler.o: PersonIndexByLocationBittingLevelHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationBittingLevelHandler.o PersonIndexByLocationBittingLevelHandler.cpp

${OBJECTDIR}/PersonIndexByLocationExternalPopulationMovingLevel.o: PersonIndexByLocationExternalPopulationMovingLevel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationExternalPopulationMovingLevel.o PersonIndexByLocationExternalPopulationMovingLevel.cpp
...
${OBJECTDIR}/PersonIndexByLocationExternalPopulationMovingLevelHandler.o: PersonIndexByLocationExternalPopulationMovingLevelHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationExternalPopulationMovingLevelHandler.o PersonIndexByLocationExternalPopulationMovingLevelHandler.cpp

${OBJECTDIR}/PersonIndexByLocationMovingLevel.o: PersonIndexByLocationMovingLevel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationMovingLevel.o PersonIndexByLocationMovingLevel.cpp

${OBJECTDIR}/PersonIndexByLocationMovingLevelHandler.o: PersonIndexByLocationMovingLevelHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationMovingLevelHandler.o PersonIndexByLocationMovingLevelHandler.cpp

${OBJECTDIR}/PersonIndexByLocationStateAgeClass.o: PersonIndexByLocationStateAgeClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationStateAgeClass.o PersonIndexByLocationStateAgeClass.cpp

${OBJECTDIR}/PersonIndexByLocationStateAgeClassHandler.o: PersonIndexByLocationStateAgeClassHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonIndexByLocationStateAgeClassHandler.o PersonIndexByLocationStateAgeClassHandler.cpp

${OBJECTDIR}/Phenotype.o: Phenotype.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Phenotype.o Phenotype.cpp
...
${OBJECTDIR}/ProgressToClinicalEvent.o: ProgressToClinicalEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProgressToClinicalEvent.o ProgressToClinicalEvent.cpp
...
${OBJECTDIR}/ReceiveMDADrugEvent.o: ReceiveMDADrugEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReceiveMDADrugEvent.o ReceiveMDADrugEvent.cpp

${OBJECTDIR}/ReceiveTherapyEvent.o: ReceiveTherapyEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReceiveTherapyEvent.o ReceiveTherapyEvent.cpp

${OBJECTDIR}/Reporter.o: Reporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Reporter.o Reporter.cpp

${OBJECTDIR}/ResistanceTracker.o: ResistanceTracker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResistanceTracker.o ResistanceTracker.cpp

${OBJECTDIR}/ReturnToNormalPopulationEvent.o: ReturnToNormalPopulationEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReturnToNormalPopulationEvent.o ReturnToNormalPopulationEvent.cpp

${OBJECTDIR}/ReturnToResidenceEvent.o: ReturnToResidenceEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReturnToResidenceEvent.o ReturnToResidenceEvent.cpp

${OBJECTDIR}/SCTherapy.o: SCTherapy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SCTherapy.o SCTherapy.cpp

${OBJECTDIR}/SFTStrategy.o: SFTStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SFTStrategy.o SFTStrategy.cpp

${OBJECTDIR}/STCAction.o: STCAction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/STCAction.o STCAction.cpp
...
${OBJECTDIR}/SwitchImmuneComponentEvent.o: SwitchImmuneComponentEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SwitchImmuneComponentEvent.o SwitchImmuneComponentEvent.cpp

${OBJECTDIR}/TACTSwitchingStrategy.o: TACTSwitchingStrategy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TACTSwitchingStrategy.o TACTSwitchingStrategy.cpp

${OBJECTDIR}/TMEAction.o: TMEAction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TMEAction.o TMEAction.cpp

${OBJECTDIR}/TMEActionFactory.o: TMEActionFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TMEActionFactory.o TMEActionFactory.cpp

${OBJECTDIR}/TMEScheduler.o: TMEScheduler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TMEScheduler.o TMEScheduler.cpp

${OBJECTDIR}/TestTreatmentFailureEvent.o: TestTreatmentFailureEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestTreatmentFailureEvent.o TestTreatmentFailureEvent.cpp
...
${OBJECTDIR}/UpdateEveryKDaysEvent.o: UpdateEveryKDaysEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UpdateEveryKDaysEvent.o UpdateEveryKDaysEvent.cpp

${OBJECTDIR}/UpdateWhenDrugIsPresentEvent.o: UpdateWhenDrugIsPresentEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UpdateWhenDrugIsPresentEvent.o UpdateWhenDrugIsPresentEvent.cpp

${OBJECTDIR}/YearlyReporterV1.o: YearlyReporterV1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/YearlyReporterV1.o YearlyReporterV1.cpp
