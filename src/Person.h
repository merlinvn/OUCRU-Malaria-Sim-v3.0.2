...
class Person
        : public PersonIndexAllHandler,
          public PersonIndexByLocationStateAgeClassHandler,
          public PersonIndexByLocationBittingLevelHandler,
          public PersonIndexByLocationMovingLevelHandler,
          public Dispatcher,
          public PersonIndexByLocationExternalPopulationMovingLevelHandler {
public:
...
public:
    ...
    void schedule_test_treatment_failure_event(ClonalParasitePopulation *blood_parasite, const int &testing_day,
                                               const bool &isRes = true, const int &t_id = 0);
