...
A_3 = dlmread('results_beta0p5_k4_f0p6_cr0p005_3act_age2_10.txt');
A_C  = dlmread('results_beta0p5_k4_f0p6_cr0p005_cycling_age2_10.txt');
A_S  = dlmread('results_beta0p5_k4_f0p6_cr0p005_seq_age2_10.txt');
...
prevalence_from =0;
prevalence_to =30;
yticks = 0:5:prevalence_to;
yticklabels = {'0%','5%','10%','15%','20%','25%','30%'};

scale_factor = 5000;
ref_line_pos = 20;
%ntf #5 med_ntf from Figure 1 plot
% 21.1567   21.4905   22.0679



med_ntf = [21.5500000000000,25.4000000000000,25.3000000000000];
up_ntf = [21.9000000000000,25.6000000000000,26.2000000000000];
down_ntf = [21.3000000000000,25.2000000000000,24.8000000000000];
...
plot([0 7300], [ref_line_pos ref_line_pos], '--','LineWidth', 1, 'Color', myLightGray); hold on;
