...
PersonIndexByLocationExternalPopulationMovingLevel::PersonIndexByLocationExternalPopulationMovingLevel(
        const int &no_location, const int &no_level) {
    Initialize(no_location, no_level);
}

PersonIndexByLocationExternalPopulationMovingLevel::PersonIndexByLocationExternalPopulationMovingLevel(
        const PersonIndexByLocationExternalPopulationMovingLevel &orig) {
}
...
void PersonIndexByLocationExternalPopulationMovingLevel::notify_change(Person *p,
                                                                       const Person::PersonProperties &property,
...
void PersonIndexByLocationExternalPopulationMovingLevel::add(Person *p, const int &location,
                                                             const int &external_population_moving_level) {
    vPerson_[location][external_population_moving_level].push_back(p);
    p->PersonIndexByLocationExternalPopulationMovingLevelHandler::set_index(
            vPerson_[location][external_population_moving_level].size() - 1);
}

void PersonIndexByLocationExternalPopulationMovingLevel::remove_without_set_index(Person *p) {
    vPerson_[p->location()][p->external_population_moving_level()].back()->PersonIndexByLocationExternalPopulationMovingLevelHandler::set_index(
            p->PersonIndexByLocationExternalPopulationMovingLevelHandler::index());
...
void PersonIndexByLocationExternalPopulationMovingLevel::change_property(Person *p, const int &location,
